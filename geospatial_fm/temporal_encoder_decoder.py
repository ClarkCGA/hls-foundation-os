...
# HEADS = Registry('head', parent=MMENGINE_MODELS, scope='mmpretrain', locations=['mmpretrain.models.heads'])
# LOSSES = Registry('loss', parent=MMENGINE_MODELS, scope='mmpretrain', locations=['mmpretrain.models.losses'])

from mmengine.registry import METRICS
from mmpretrain.evaluation.metrics.multi_label import MultiLabelMetric, AveragePrecision
METRICS.register_module()(MultiLabelMetric)
METRICS.register_module()(AveragePrecision)

from mmengine.registry import HOOKS
from mmpretrain.engine.hooks.visualization_hook import VisualizationHook
HOOKS.register_module()(VisualizationHook)

from mmengine.registry import VISUALIZERS
from mmpretrain.visualization.visualizer import UniversalVisualizer
VISUALIZERS.register_module()(UniversalVisualizer)
...
MODELS.register_module()(CrossEntropyLoss)
